...
/*   Updated: 2022/03/03 13:30:59 by rozhou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_strcmp(s->bob->token[0], "cd") == 0)
		ft_cd(s);
	else if (ft_strcmp(s->bob->token[0], "echo") == 0)
		ft_echo(s);
	else if (ft_strcmp(s->bob->token[0], "pwd") == 0)
		ft_pwd();
	else if (ft_strcmp(s->bob->token[0], "export") == 0)
		ft_export(s);
	else if (ft_strcmp(s->bob->token[0], "unset") == 0)
		ft_unset(s);
	else if (ft_strcmp(s->bob->token[0], "env") == 0)
		ft_env(s);
	else if (ft_strcmp(s->bob->token[0], "exit") == 0)
		ft_pipexit(s);
	else
		return (0);
	return (1);
...
{
	if (ft_strcmp(s->bob->token[0], "cd") == 0 && i == 0 && !s->bob->next)
